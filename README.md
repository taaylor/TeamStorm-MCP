...
```bash
uv tool install git+https://github.com/USERNAME/teamstorm-mcp.git
```

Перед выполнением команды замените `USERNAME` на владельца репозитория.
...
изменения, а затем добавить технический отчёт в комментарий задачи. Явный
запрет пользователя на запись в TeamStorm всегда имеет приоритет.
